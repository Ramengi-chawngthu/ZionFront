...
function BookmarksSvg() {
  return (
    ...
    >
      <mask
        id='mask0 '
        mask-type='alpha overflow="visible"'
        maskUnits='userSpaceOnUse overflow="visible"'
        x='0'
        y='0'
        width='18'
        height='21'
      ...
      <path
        fill-rule='evenodd'
        clip-rule='evenodd'
        d='M12.1398 8.2285H4.82178C4.40778 8.2285 4.07178 7.8925 4.07178 7.4785C4.07178 7.0645 4.40778 6.7285 4.82178 6.7285H12.1398C12.5538 6.7285 12.8898 7.0645 12.8898 7.4785C12.8898 7.8925 12.5538 8.2285 12.1398 8.2285Z'
        fill='#7768F2'
      />
    </svg>
  );
