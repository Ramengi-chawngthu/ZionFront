...
function Sidebar() {
  ...
  function handleOptionSelect(option) {
    ...
    switch (option) {
      case 1:
        option1.current.style.backgroundColor = "rgba(119, 104, 242, 0.05)";
        ...
        break;
      case 2:
        option2.current.style.backgroundColor = "rgba(119, 104, 242, 0.05)";
        option1.current.style.backgroundColor = "#FFF";
        option3.current.style.backgroundColor = "#FFF";
        option4.current.style.backgroundColor = "#FFF";
        break;
      case 3:
        option3.current.style.backgroundColor = "rgba(119, 104, 242, 0.05)";
        option1.current.style.backgroundColor = "#FFF";
        option2.current.style.backgroundColor = "#FFF";
        option4.current.style.backgroundColor = "#FFF";
        break;
      case 4:
        option4.current.style.backgroundColor = "rgba(119, 104, 242, 0.05)";
        option1.current.style.backgroundColor = "#FFF";
        option2.current.style.backgroundColor = "#FFF";
        option3.current.style.backgroundColor = "#FFF";
        break;
